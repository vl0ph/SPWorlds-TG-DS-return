...
> Временные расширения Firefox автоматически удаляются после полного перезапуска браузера. Для постоянной установки требуется публикация в Firefox Add-ons или подпись расширения.
